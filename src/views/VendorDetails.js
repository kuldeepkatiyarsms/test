...
import { Container, Content, Card, Left, Body, Right, Col, Row , View, Icon, ListItem, List } from 'native-base';
...
class VendorDetails extends Component<Props> {
  constructor(props) {
    super(props);
        ...
        <View style={styles.ven_style1} >
          ...
          <Card style={styles.ven_style3}>
              <Row style={styles.ven_style4}>
                <Left style={styles.ven_style5}>
                 <TouchableOpacity style={styles.ven_style6} onPress={this.handleBackButtonClick} activeOpacity={1} >
                     <Icon onPress={this.handleBackButtonClick} style={styles.ven_style7} name='ios-arrow-back' />
                  </TouchableOpacity> 
                </Left>
                <Body style={styles.ven_style8}>
                  <Text
          ...
          <View style={styles.ven_style12}>
            ...
            >
              ...
              <Row>
                ...
                <Col style={styles.ven_style22} />
                <Col style={styles.ven_style23}>
                  <Text
