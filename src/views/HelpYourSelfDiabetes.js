...
export default class HelpYourSelfDiabetes extends Component<Props> {
      ...
      <Container>
        ...
        <ScrollView keyboardShouldPersistTaps="always">
          <View style={{ justifyContent: "center", alignItems: "center" }} >
            ...
            <View style={{ flexDirection: 'column',height: getSizeHeight(180), }}>
              ...
              <ScrollView horizontal={true}>
                <View style={{ paddingRight:getSizeWidth(14),  marginLeft:getSizeWidth(12), marginTop: getSizeHeight(10), justifyContent: 'center', alignItems: 'center', width: '100%', height: getSizeHeight(118), flexDirection: 'row' }}>
                  <View style={{ width: getSizeWidth(220), height: getSizeHeight(118), backgroundColor: '#FFF9ED' }}>
                    <View style={{ flexDirection: 'row' }}>
                      <Text style={[{ fontFamily: Roboto, fontSize: getFontRatio(14), lineHeight: 15.22, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(35) }]}>{'Prevention Plan'}</Text>
                  ...
                  <View style={{ marginLeft: getSizeWidth(5), width: getSizeWidth(190), height: getSizeHeight(118), backgroundColor: '#FFEDED' }}>


                    <View style={{ flexDirection: 'row' }}>
                      <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(14), lineHeight: 15.22, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(35) }]}>{'Reversal Plan'}</Text>
                  ...
                  <View style={{ marginLeft: getSizeWidth(10), width: getSizeWidth(220), height: getSizeHeight(118), backgroundColor: '#FFEDED' }}>


                    <View style={{ flexDirection: 'row' }}>
                      <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(14), lineHeight: 15.22, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(35) }]}>{'Management Plan'}</Text>
