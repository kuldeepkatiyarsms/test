      ...
      <View style={styles.res_style1}>
        ...
        <View>
          <View style={styles.res_style2}>
            <TouchableOpacity style={styles.res_style3} onPress={this.handleBackButtonClick} activeOpacity={1} >
              <Icon onPress={this.handleBackButtonClick} style={styles.res_style4} name='arrow-back' />
            </TouchableOpacity>
          ...
          >
            <Card style={styles.res_style9}>
              <Row style={styles.res_style10}>
                <Left style={styles.res_style11}>
                  <TouchableOpacity style={styles.res_style12} onPress={this.handleBackButtonClick} activeOpacity={1} >
                     <Icon onPress={this.handleBackButtonClick} style={styles.res_style13} name='ios-arrow-back' />
                  </TouchableOpacity>  
                </Left>
                <Body style={styles.res_style14}>
                  <Text
