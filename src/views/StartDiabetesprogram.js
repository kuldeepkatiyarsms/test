...
import BookIcon from '../config/SVG/Back';
...
const CONTENT = [
  ...
  {
    id: '4',
    categoryName: 'What is the difference between diabetes reversal and cure?',
...
export default class StartDiabetesprogram extends Component<Props> {
      ...
      <Container>
        ...
        <View>
          <View style={styles.pro_style1}>
            ...
            <View >
              <Text style={styles.pro_style5}>{"Diabetes Program"}</Text></View>
        ...
        <ScrollView keyboardShouldPersistTaps="always">
          ...
          <View style={styles.home_style1Book}>
            ...
            <View style={{marginHorizontal:getSizeWidth(14), marginTop:getSizeHeight(29), width:'94%', flexDirection: 'row', justifyContent:"space-between" }}>
              ...
              <Text style={[styles.pro_style5, { borderRadius:getSizeWidth(5), backgroundColor: '#FFE8B9', padding: getSizeWidth(5),  marginRight: getSizeWidth(14), textAlign: 'center', fontSize: getFontRatio(10), color: '#000000', marginTop: getSizeHeight(12), lineHeight: 15 }]}>{"Starting at INR 1450"}</Text>


            </View>

            <Text style={[styles.pro_style5, {marginHorizontal:getSizeWidth(14),  marginRight: getSizeWidth(10),  fontSize: getFontRatio(12), color: '#2D3E4D', marginTop: getSizeHeight(12), lineHeight: 15 }]}>{"A clinically proven program to reduce blood sugar and manage co-morbidities to prevent health complications."}</Text>
            ...
            <View style={{ marginTop:getSizeHeight(30), width:'95%', borderRadius: getSizeWidth(6), height: getSizeHeight(50), backgroundColor: '#F18261', paddingLeft: getSizeWidth(8), paddingRight: getSizeWidth(8), alignItems: 'center', justifyContent: 'center' }}>
              <Text style={[styles.home_style1TitlePreventButtonText, { color: '#ffffff', textAlign: 'center', }]}>{'Start my program'}</Text>

            </View>

            {/* <View style={{marginHorizontal:getSizeWidth(14),  width:'92%',  height: getSizeHeight(235), backgroundColor: '#FFF9ED' }}>
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(12), lineHeight: 14.46, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(5) ,opacity:0.30 }]}>{'\u20B9 590 per month | \u20B9 1490 for 3 months'}</Text>
                    ...
                    <View style={{flexDirection:'row'}}>
                    <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(14), lineHeight: 16.8, color: '#FB9085', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(10),marginRight:getSizeWidth(8) }]}>{'View More'}</Text>
                  ...
                  <View style={{ flexDirection: 'row', marginTop: getSizeHeight(10), marginHorizontal: getSizeWidth(16) }}>
            ...
            {/* <View style={{marginBottom:getSizeHeight(-10), marginTop:getSizeHeight(20), marginHorizontal:getSizeWidth(14),  width:'92%',  height: getSizeHeight(235), backgroundColor: '#FFEDED' }}>
                  <View style={{ flexDirection: 'row' }}>
                    <View style={{flexDirection:'column'}}>
                    ...
                    <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(12), lineHeight: 14.46, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(5) ,opacity:0.30 }]}>{'\u20B9 1990 per month | \u20B9 5550 for 3 months'}</Text>
                    <Text style={[{ fontFamily: Lato_Regular, fontSize: getFontRatio(14), lineHeight: 16.8, color: '#1D5471', marginHorizontal: getSizeWidth(16), marginTop: getSizeHeight(10),marginRight:getSizeWidth(120) }]}>{'Basic Plan Consists of Mild lifestyle changes that will help beginners to achieve their goals'}</Text>
...
const styles = StyleSheet.create({
  ...
  home_style1Book: { backgroundColor: '#1D5471', flexDirection: 'row', marginHorizontal: getSizeWidth(16), borderRadius: getSizeWidth(10), borderWidth: 1, borderColor: '#F18261', height: getSizeHeight(80), alignItems: 'center', marginTop: getSizeHeight(10), },
