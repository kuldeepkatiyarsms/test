...
import { Content, Container, Row, Col, Icon,  } from 'native-base';
      ...
      <Container>
        <View>
          <View style={styles.appointment_style1}>
            <TouchableOpacity style={styles.appointment_style2} onPress={this.handleBackButtonClick} activeOpacity={1} >
              <Icon onPress={this.handleBackButtonClick} style={styles.appointment_style3} name='arrow-back' />
            </TouchableOpacity>
            <View style={styles.appointment_style4} />
            <Text style={styles.appointment_style5}>Appointment Info</Text>
          </View>
        </View> 
        <Content style={styles.appointment_style6}>
        <CardView
          cardElevation={2}
          cardMaxElevation={2}>
          <View style={styles.appointment_style7}>
            <Row>
              <Col style={styles.appointment_style8}> 
              ...
              <Col style={styles.appointment_style12}> 
          ...
          <View style={styles.appointment_style15}/>
            <Row>
              <Col style={styles.appointment_style16}> 
              ...
              <Col style={styles.appointment_style18}> 
          ...
          <View style={styles.appointment_style22}/>
            <Row>
              <Col style={styles.appointment_style23}> 
                <Image style={styles.appointment_style24} source={location}/>
              </Col>
              <Col style={styles.appoinment_style25}> 
        ...
        <View style={styles.appoinment_style30}/>
          ...
          <View style={styles.appoinment_style31}>
            <View style={styles.appoinment_style32}/>
              <Row>
                <Col style={styles.appoinment_style33}> 
                ...
                <Col style={styles.appoinment_style35}> 
            ...
            <View style={styles.appoinment_style39}/>
               <Row>
                <Col style={styles.appoinment_style40}> 
                ...
                <Col style={styles.appoinment_style42}> 
